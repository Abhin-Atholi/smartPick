...
export const loadRegister = (req, res) => res.render("user/auth/register", { title: "Register", msg: req.query.msg || null, name: req.query.name || "", email: req.query.email || "", referralCode: req.query.ref || "" });
...
export const loadForgotPassword = (req, res) => {
  res.render("user/auth/forgot-password", { title: "Forgot Password", msg: req.query.msg || null });
};
