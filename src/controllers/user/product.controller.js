import * as userProductService from "../../services/user/product.service.js";
...
export const loadProductDetails = async (req, res) => {
  try {
    ...
    const minPricing = (await import("../../services/common/pricing.service.js")).calculateItemPrice(minPrice, offers);
    const maxPricing = (await import("../../services/common/pricing.service.js")).calculateItemPrice(maxPrice, offers);
    ...
    // Fetch Reviews
    const reviewService = await import("../../services/user/review.service.js");
