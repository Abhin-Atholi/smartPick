...
export const aggregateOrderFinancials = (order) => {
    ...
    // refund.service.js says: "Shipping Refund Rules: Shipping is non-refundable in all scenarios. Even in FULL_CANCEL, we retain the shipping fee as a processing/service charge. shippingRefund = 0;"
