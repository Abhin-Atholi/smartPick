...
import { getOrderStatusBadge, getItemStatusBadge, getPaymentStatusBadge } from './orderPresentation.service.js';
...
export const formatAdminOrderForDisplay = (order) => {
    ...
    return {
        ...
        canUpdateStatus: !['Delivered', 'Return Requested', 'Returned', 'Cancelled', 'Partially Returned', 'Payment Pending', 'Payment Failed', 'Expired'].includes(order.orderStatus),
